...
def plot_all_types(gqphi, mass_range=[1., 500.], mchi=1.e10, gchi=0.):
	...
	plotobj_br_scalar_gg, = ax1.plot(mphis, br_scalar_gg, color=darks[4], linewidth=1.0, linestyle="-", label=r"$gg$")
	...
	plotobj_br_pseudoscalar_gg, = ax1.plot(mphis, br_pseudoscalar_gg, color=darks[4], linewidth=1.0, linestyle="--", label=r"$gg$")
	pseudoscalar_legend = plt.legend(handles=[plotobj_br_pseudoscalar_tt, plotobj_br_pseudoscalar_bb, plotobj_br_pseudoscalar_cc, plotobj_br_pseudoscalar_gg, ], loc=(0.75, 0.2), title="Pseudoscalar")
