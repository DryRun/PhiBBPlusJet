...
def plot_all_types(gqphi, mass_range=[1., 500.], mchi=1.e10, gchi=0.):
	...
	scalar_legend = plt.legend(handles=[plotobj_br_scalar_tt, plotobj_br_scalar_bb, plotobj_br_scalar_cc, plotobj_br_scalar_gg, ], loc=(0.1, 0.33), title="Scalar")
	...
	pseudoscalar_legend = plt.legend(handles=[plotobj_br_pseudoscalar_tt, plotobj_br_pseudoscalar_bb, plotobj_br_pseudoscalar_cc, plotobj_br_pseudoscalar_gg, ], loc=(0.7., 0.33), title="Pseudoscalar")
