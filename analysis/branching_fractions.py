...
def plot(gqphi, phi_type, mass_range=[1., 500.], mchi=1.e10, gchi=0.):
	...
	ax2.plot(mphis, width_total, color="black", linewidth=2.0, linestyle="--")
	ax2.plot(mphis, width_tt, color=pastels[2], linewidth=1.0, linestyle="--")
	ax2.plot(mphis, width_bb, color=pastels[0], linewidth=1.0, linestyle="--")
	ax2.plot(mphis, width_cc, color=pastels[5], linewidth=1.0, linestyle="--")
	ax2.plot(mphis, width_gg, color=pastels[1], linewidth=1.0, linestyle="--")
